...
return (
    <div className="container">
      <div className="grid">
      <div className="dis">
        <input type="text" value={expression} placeholder="0" disable />
    ...
    <div onClick={clear} className="padButton C tomato">C</div>
        ...
        <div onClick={() => display("-")} className="padButton minus dark-gray">-</div>
        ...
        <div onClick={() => display("+")} className="padButton plus dark-gray">+</div>
